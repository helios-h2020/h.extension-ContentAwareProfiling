...
public class CoarseClassifierInstrumentedTest {
    ...
    public void isCoarseClassifierCorrect() throws IOException {
        ...
        double[] profile09 = ((CNNModelData) ((CoarseInterestsProfile) profile).getModelData()).getRawProfile(0.9f, ModelType.COARSE)
                .stream()
        ...
        double[] profile05 = ((CNNModelData) ((CoarseInterestsProfile) profile).getModelData()).getRawProfile(0.5f, ModelType.COARSE)
                .stream()
                .mapToDouble(f -> f != null ? f : Float.NaN)
                .toArray();
        ...
        double[] profile03 = ((CNNModelData) ((CoarseInterestsProfile) profile).getModelData()).getRawProfile(0.3f, ModelType.COARSE)
                .stream()
                .mapToDouble(f -> f != null ? f : Float.NaN)
                .toArray();
